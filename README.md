...
```
Add your ShipEngine API Key: Open the .env file and replace the placeholder with your actual key
Database & Redis: The default settings in .env.example are pre-configured.
```
